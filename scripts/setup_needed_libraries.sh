...
if [ "$CURRENT_FOLDER" != "$DEVELOPER_DIRECTORY_NAME" ]; then
  ...
  echo -e "${echo_note_color}To fix this go into the script \"setup_needed_libraries.sh\" and change the name in ${echo_file_highlight_color}line: 21\n"
